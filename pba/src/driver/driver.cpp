...
int main(int argc, char* argv[]) 
{
	...
	//argv[0]="-schur,--float";  
	//argv[0]="-schur";  
	//argv[0]="--float,--convert_to_nvm";  
	//argv[0]="--float,--convert_to_bm";  
	//argv[1]="F:\\毕业论文\\数据\\problem-16-22106-pre.txt";   

	//argv[1]="F:\\毕业论文\\数据\\final\\problem-93-61203-pre.txt";  
	//argv[1]="F:\\毕业论文\\数据\\final\\problem-394-100368-pre.txt"; 
	//argv[1]="F:\\毕业论文\\数据\\final\\problem-871-527480-pre.txt";  
	//argv[1]="F:\\毕业论文\\数据\\final\\problem-4585-1324582-pre.txt";  
	//argv[1]="F:\\毕业论文\\数据\\final\\problem-13682-4456117-pre.txt";  
	//argv[1]="F:\\毕业论文\\数据\\其他\\problem-1723-156502-pre.txt";  

	argv[1]="F:\\毕业论文\\数据\\sfm\\01-biltmore.nvm";  
	//argv[1]="F:\\毕业论文\\数据\\sfm\\02-notredame.nvm";  
	//argv[1]="F:\\毕业论文\\数据\\sfm\\03-notredame.nvm";  
	//argv[1]="F:\\毕业论文\\数据\\sfm\\04-liberty.nvm";  
	//argv[1]="F:\\毕业论文\\数据\\sfm\\05-liberty.nvm";  
	//argv[1]="F:\\毕业论文\\数据\\sfm\\06-bandenburger.nvm";  
	//argv[1]="F:\\毕业论文\\数据\\sfm\\07-berlin.nvm";  
	//argv[1]="F:\\毕业论文\\数据\\sfm\\08-rome-11678.nvm";  
	//argv[1]="F:\\毕业论文\\数据\\sfm\\09-rome-11681.nvm";  
	//argv[1]="F:\\毕业论文\\数据\\sfm\\10-sanmarco.nvm";  
	...
	//.bundle
	//.txt
	LoadModelFile(input_filename, camera_data, point_data, measurements,
...
//        //////////////////////////////////////////////////////////
		...
		//运行不了！！！使用sscanf代替
		//remove file extension for conversion/saving purpose  为了转换和保存移除文件扩展名
		//char* dotpos = strrchr(input_filename, '.');  //首次出现  .
		//if(dotpos && strchr(dotpos, '/') == NULL && strchr(dotpos, '\\') == NULL) //首次出现 . 并且不包含/和//
		//	dotpos = 0;

		char input_filename_new[25];
		sscanf(input_filename, "%[^.]", input_filename_new);
